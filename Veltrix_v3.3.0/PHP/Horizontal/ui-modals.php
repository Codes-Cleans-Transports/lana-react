...
<head>
    <meta charset="utf-8" />
    <title>Modals | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-3 mt-4">
                                            <div class="text-center">
                                                ...
                                                <!-- Large modal -->
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">Large
                                                    modal</button>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-3 mt-4">
                                            <div class="text-center">
                                                ...
                                                <!-- Small modal -->
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-sm">Small
                                                    modal</button>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-3 mt-4">
                                            <div class="text-center">
                                                ...
                                                <!-- Small modal -->
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-center">Center
                                                    modal</button>
                                            </div>
