...
<head>
    <meta charset="utf-8" />
    <title>Form Wizard | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
    ...
    <div id="layout-wrapper">
                                    ...
                                    <form id="form-horizontal" class="form-horizontal form-wizard-wrapper">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="txtCardVerificationNumber" class="col-lg-3 col-form-label">Card Verification
                                                            Number</label>
                                                        <div class="col-lg-9">
        ...
        <!-- form wizard -->
        <script src="public/libs/jquery-steps/build/jquery.steps.min.js"></script>

        <!-- form wizard init -->
        <script src="public/js/pages/form-wizard.init.js"></script>
