...
<head>
    <meta charset="utf-8" />
    <title>typicons | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row icon-demo-content">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-heart-half-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-info-large-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-lock-closed-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-eject-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-fast-forward"></i> typcn
                                            typcn-media-fast-forward
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-pause-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-play-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-play-reverse"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-media-stop-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-microphone-outline"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-social-at-circular"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-social-google-plus"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-sort-alphabetically"></i> typcn
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <i class="typcn typcn-user-delete-outline"></i> typcn
