                                        ...
                                        <ul class="timeline list-unstyled">
                                            ...
                                            <li class="timeline-list right clearfix">
                                                <div class="cd-timeline-content p-4">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-t-5">See
                                                        more detail</button>
                                            ...
                                            <li class="timeline-list">
                                                <div class="cd-timeline-content p-4">
                                                    ...
                                                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                                        ...
                                                        dolores et</p>
                                                    <img src="public/images/small/img-1.jpg" alt="" class="rounded mr-1" width="120">
                                                    <img src="public/images/small/img-2.jpg" alt="" class="rounded" width="120">
                                            ...
                                            <li class="timeline-list right clearfix">
                                                <div class="cd-timeline-content p-4">
                                                    ...
                                                    <p class="mb-0">languages are members of the same family. Their
                                                        separate existence is a myth... <a href="#" class="text-primary">Read More</a></p>
