...
<head>
    <meta charset="utf-8" />
    <title>Faqs | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="text-center faq-title pt-4 pb-4">
                                                ...
                                                <p class="text-muted">If several languages coalesce, the grammar of the
                                                    ...
                                                    individual languages.</p>
                                                <button type="button"
                                                    class="btn btn-primary mt-2 mr-1 waves-effect waves-light">Email
                                                    Us</button>
                                                <button type="button"
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-5">
                                            <h5 class="mt-0 font-size-18 mb-4"><i
                                                    class="ti-agenda text-primary mr-2"></i> General Questions</h5>
                                            <div class="accordion" id="accordionExample">
                                                <div class="card mb-0">
                                                    <a data-toggle="collapse" href="#collapseOne" class="faq"
                                                    ...
                                                    <div id="collapseOne" class="collapse show"
                                                        ...
                                                        <div class="card-body">
                                                            <p class="text-muted mb-0 faq-ans">The new common language
                                                ...
                                                <div class="card mb-0">
                                                    ...
                                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                        ...
                                                        <div class="card-body">
                                                            <p class="text-muted mb-0 faq-ans">Everyone realizes why a
                                                                new common language would be desirable: one could refuse
                                                                to pay expensive translators. To achieve this, it would
                                                ...
                                                <div class="card mb-0">
                                                    <a data-toggle="collapse" href="#collapseThree"
                                                        class="faq collapsed" aria-expanded="false"
                                                    ...
                                                    <div id="collapseThree" class="collapse"
                                                        ...
                                                        <div class="card-body">
                                                            <p class="text-muted mb-0 faq-ans">If several languages
                                                                coalesce, the grammar of the resulting language is more
                                                                simple and regular than that of the individual
                                                                languages. The new common language will be more simple
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-5 offset-lg-1">
                                            <h5 class="mt-0 font-size-18 mb-4"><i
                                                    class="ti-bookmark-alt text-primary mr-2"></i> Pricing & Plans</h5>
                                            <div class="accordion" id="accordionExample2">
                                                <div class="card mb-0">
                                                    <a data-toggle="collapse" href="#collapseFive" class="faq"
