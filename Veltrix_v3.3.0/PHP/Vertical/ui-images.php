                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        <img class="img-thumbnail" alt="200x200" width="200"
                                            src="public/images/small/img-3.jpg" data-holder-rendered="true">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        <img class="rounded mr-2 mo-mb-2" alt="200x200" width="200"
                                            src="public/images/small/img-4.jpg" data-holder-rendered="true">
                                        <img class="rounded-circle" alt="200x200" src="public/images/users/user-4.jpg"
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        <img src="public/images/small/img-2.jpg" class="img-fluid"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="media mb-4">
                                        <img class="d-flex mr-3 rounded-circle" src="public/images/users/user-6.jpg"
                                    ...
                                    <div class="media mb-4">
                                        <img class="d-flex mr-3 rounded-circle" src="public/images/users/user-2.jpg"
                                            alt="Generic placeholder image" height="64">
                                        <div class="media-body">
                                            <h5 class="mt-0 font-16">Media heading</h5>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                                            ...
                                            <div class="media mt-3">
                                                <a class="d-flex pr-3" href="#">
                                                    <img src="public/images/users/user-3.jpg"
                                                        alt="Generic placeholder image" height="64"
                                    ...
                                    <div class="media">
                                        ...
                                        <img class="d-flex ml-3 rounded-circle" src="public/images/users/user-4.jpg"
                                            alt="Generic placeholder image" height="64">
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media mb-4">
                                        <img class="d-flex align-self-start rounded mr-3"
                                            src="public/images/users/user-3.jpg" alt="Generic placeholder image"
                                            height="64">
                                        <div class="media-body">
                                    ...
                                    <div class="media mb-4">
                                        <img class="d-flex align-self-center rounded mr-3"
                                            src="public/images/users/user-5.jpg" alt="Generic placeholder image"
                                            height="64">
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <img class="d-flex align-self-end rounded mr-3"
                                            src="public/images/users/user-1.jpg" alt="Generic placeholder image"
                                            height="64">
                                        <div class="media-body">
