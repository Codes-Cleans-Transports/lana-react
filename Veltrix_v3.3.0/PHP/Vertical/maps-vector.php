...
<head>
    ...
    <!-- plugin css -->
    <link href="public/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet"
        type="text/css" />
...
<?php include 'layouts/master.php'; echo setLayout();?>
    ...
    <script src="public/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
