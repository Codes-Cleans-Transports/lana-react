...
<head>
    <meta charset="utf-8" />
    <title>Topbar Light | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
    ...
    echo setLayout("light"); ?>

    <!-- Begin page -->
    <div id="layout-wrapper">
        <?php include 'layouts/horizontal/topbar.php'; ?>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="font-size-18">Topbar Light</h4>
                                    ...
                                    <ol class="activity-feed">
                                        ...
                                        <li class="feed-item">
                                            <div class="feed-item-list">
                                                ...
                                                <span class="activity-text">At vero accusamus et iusto odio dignissimos
                                                    ducimus qui deleniti atque...<a href="#" class="text-success">Read
                                                        more</a></span>
                                            </div>
                                        </li>
                                        <li class="feed-item">
                                        ...
                                        <li class="feed-item">
                                            <div class="feed-item-list">
                                                ...
                                                <span class="activity-text">Sed ut perspiciatis omnis iste natus error
                                                    sit rem.</span>
                                            </div>
                                        </li>
                                    </ol>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-0"><img src="public/images/users/user-3.jpg" alt="" class="avatar-sm rounded-circle mr-2"> James Athey</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover table-centered table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="public/images/users/user-2.jpg" alt="" class="avatar-xs rounded-circle mr-2"> Philip Smead
                                                        </div>
                                                    </td>
                                                    <td>15/1/2018</td>
                                                    <td>$94</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="public/images/users/user-3.jpg" alt="" class="avatar-xs rounded-circle mr-2"> Brent Shipley
                                                        </div>
                                                    </td>
                                                    <td>16/1/2019</td>
                                                    <td>$112</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="public/images/users/user-4.jpg" alt="" class="avatar-xs rounded-circle mr-2"> Robert Sitton
                                                        </div>
                                                    </td>
                                                    <td>17/1/2019</td>
                                                    <td>$116</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="public/images/users/user-5.jpg" alt="" class="avatar-xs rounded-circle mr-2"> Alberto Jackson
                                                        </div>
                                                    </td>
                                                    <td>18/1/2019</td>
                                                    <td>$109</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="public/images/users/user-6.jpg" alt="" class="avatar-xs rounded-circle mr-2"> David Sanchez
                                                        </div>
                                                    </td>
                                                    <td>19/1/2019</td>
                                                    <td>$120</td>
                                        ...
                                        <ul class="conversation-list" data-simplebar style="max-height: 367px;">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="public/images/users/user-2.jpg" class="avatar-xs rounded-circle" alt="male">
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="public/images/users/user-3.jpg" class="avatar-xs rounded-circle" alt="Female">
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="public/images/users/user-3.jpg" class="avatar-xs rounded-circle" alt="male">
                                            ...
                                            <li class="clearfix odd">
                                                ...
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                                        ...
                                                        <img src="public/images/small/img-1.jpg" alt="" height="48" class="rounded mr-2">
                                                        <img src="public/images/small/img-2.jpg" alt="" height="48" class="rounded">
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
