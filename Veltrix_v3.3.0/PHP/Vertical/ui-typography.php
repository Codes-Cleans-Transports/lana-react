...
<head>
    <meta charset="utf-8" />
    <title>Typography | Veltrix - Responsive Bootstrap 4 Admin Dashboard</title>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h1>h1. Bootstrap heading <small class="text-muted">Semibold 2.5rem (40px)</small>
                                </h1>
                                <h2>h2. Bootstrap heading <small class="text-muted">Semibold 2rem (32px)</small>
                                </h2>
                                <h3>h3. Bootstrap heading <small class="text-muted">Semibold 1.75rem (28px)</small>
                                </h3>
                                <h4>h4. Bootstrap heading <small class="text-muted">Semibold 1.5rem (24px)</small>
                                </h4>
                                <h5>h5. Bootstrap heading <small class="text-muted">Semibold 1.25rem (20px)</small>
                                </h5>
                                <h6>h6. Bootstrap heading <small class="text-muted">Semibold 1rem (16px)</small>
                                </h6>
                            </div>
                        </div>
