                    ...
                    <div class="row">
                            ...
                            <div class="card directory-card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0"><b>Intro : </b>At vero eos et accusamus et iusto odio dignissimos
                                        ducimus qui blanditiis atque corrupti quos dolores et... <a href="#"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card">
                                <div class="card-body">
                                    <div class="media">
                                        <img src="public/images/users/user-7.jpg" alt=""
                                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                        <div class="media-body ml-3">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card">
                                <div class="card-body">
                                    <div class="media">
                                        <img src="public/images/users/user-8.jpg" alt=""
                                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                        <div class="media-body ml-3">
                                            <h5 class="text-primary font-size-18 mt-0 mb-1">Jerome A. Hebert</h5>
                                            <p class="font-size-12 mb-2">Creative Director</p>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card">
                                <div class="card-body">
                                    <div class="media">
                                        <img src="public/images/users/user-9.jpg" alt=""
                                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                        <div class="media-body ml-3">
                                            <h5 class="text-primary font-size-18 mt-0 mb-1">Adam V. Acker</h5>
                                            <p class="font-size-12 mb-2">Creative Director</p>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card directory-card">
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <img src="public/images/users/user-10.jpg" alt=""
                                            class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                        <div class="media-body ml-3">
