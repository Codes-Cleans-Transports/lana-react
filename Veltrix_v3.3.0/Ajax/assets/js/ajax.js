...
function my_ajax(page) {
	...
	if(page === "index.html")
	{
		document.title = "Dashboard | Veltrix - Responsive Bootstrap 4 Admin Dashboard";
	}
	else
	{
		var title = page.replace(".html", "");
		var title1 = title.replace("-", " ");
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | Veltrix - Responsive Bootstrap 4 Admin Dashboard";
	}
